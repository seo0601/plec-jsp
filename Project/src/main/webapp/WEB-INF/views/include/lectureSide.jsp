...
<div class="col-md-2">
	<h5><a href="${pageContext.request.contextPath}/lecture/list?large_category=front&small_category=0" class="${selectLecture == 'frontend' ? 'selectedLecture' : '' }">웹프론트엔드</a></h5>
	...
	<br><br><h5><a href="${pageContext.request.contextPath}/lecture/list?large_category=backend&small_category=0" class="${selectLecture == 'backend' ? 'selectedLecture' : '' }">웹백엔드</a></h5>
	...
	<br><br><h5><a href="${pageContext.request.contextPath}/lecture/list?large_category=mobile&small_category=0" class="${selectLecture == 'mobile' ? 'selectedLecture' : '' }">모바일</a></h5>
