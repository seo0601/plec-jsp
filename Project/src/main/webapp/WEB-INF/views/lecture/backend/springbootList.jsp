...
<body>
	<div class="wrapper">
		...
		<div class="sub-tit-box">
			<h3 class="sub-tit">Spring boot</h3>
		</div>
		<div class="container">
			<div class="row">
					...
					<nav aria-label="Page navigation" class="page-btn">
						<ul class="pagination justify-content-center">
							...
							<c:if test="${startPageNum ne 1 }">
								<li class="page-item">
									<a class="page-link new-page-link" href="${pageContext.request.contextPath}/lecture/frontend/springbootList?pageNum=${startPageNum-1 }">Prev</a>
								</li>
							</c:if>
							<c:forEach var="i" begin="${startPageNum }" end="${endPageNum }">
								<li class="page-item ${pageNum eq i ? 'active' : '' }">
									<a class="page-link new-page-link" href="${pageContext.request.contextPath}/lecture/frontend/springbootList?pageNum=${i }">${i }</a>
								</li>
							</c:forEach>
							
							<c:if test="${endPageNum lt totalPageCount }">
								<li class="page-item">
									<a class="page-link new-page-link" href="${pageContext.request.contextPath}/lecture/frontend/springbootList?pageNum=${endPageNum+1 }">Next</a>
								</li>
							</c:if>				
						</ul>
					</nav>
