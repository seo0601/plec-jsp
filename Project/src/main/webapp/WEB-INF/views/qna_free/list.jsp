	...
	<div class="wrapper">
		...
		<div class="container">
		            ...
		            <tr style="text-align: center;">
		               ...
		               <td>
		                  <c:if test="${tmp.writer eq sessionScope.id }">
		                     <a href="javascript:deleteConfirm(${tmp.num })" class="del">삭제</a>
		                  </c:if>
		               </td>
		            </tr>
		         </c:forEach>
		  ...
		  <div class="d-flex justify-content-end">
	     	 <button class="btn btn-secondary btn-sm me-2 " type="button" onclick="location.href='${pageContext.request.contextPath }/qna_free/insertform'">새글작성</button>
	      </div>	  
