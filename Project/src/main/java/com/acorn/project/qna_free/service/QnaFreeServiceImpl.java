...
import com.acorn.project.qna_free.dao.QnaFreeAnswerDao;
import com.acorn.project.qna_free.dao.QnaFreeDao;
...
public class QnaFreeServiceImpl implements QnaFreeService {
	...
	public void getDetail(HttpServletRequest request) {
	     ...
	     */
	     ...
	     QnaFreeAnswerDto qnaAnswerDto=new QnaFreeAnswerDto();
	     ...
	     List<QnaFreeAnswerDto> commentList=qnaAnswerDao.getList(qnaAnswerDto);
	...
	@Override
	public void saveContent(QnaFreeDto dto) {		
		qnaDao.insert(dto);		
	}
	...
	public void getData(HttpServletRequest request) {
		...
		int num=Integer.parseInt(request.getParameter("num"));
		//수정할 글의 정보 얻어와서
		QnaFreeDto dto=qnaDao.getData(num);
		//request에 담아준다.
